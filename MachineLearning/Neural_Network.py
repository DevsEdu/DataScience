...
class Network(object):
    #Contrutor que recebe a quantidade o tamnho da rede e suas respectivas
    ...
    #Processamento os dados de entrada
    ...
    #Descida de gradiente estocáticos. Realizada o aprendizado da rede
...
# Função de Ativação Sigmóide, se o parãmetro for uma array, retornará uma lista com o
# exponecial com cada elemento.
def sigmoid(z):
